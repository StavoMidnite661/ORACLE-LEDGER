...
export const AccountsReceivableView: React.FC<AccountsReceivableViewProps> = ({ invoices, addInvoice }) => {
    ...
    <>
      ...
      <Modal isOpen={isNewInvoiceModalOpen} onClose={() => setIsNewInvoiceModalOpen(false)} title="Issue New AR Invoice">
         <form onSubmit={handleCreateInvoice} className="space-y-4">
            <div>
              <label htmlFor="ar-counterparty" className="block text-sm font-medium text-sov-light-alt">Customer</label>
